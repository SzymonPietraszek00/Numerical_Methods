...
set output "x1.png"       # Nazwa obrazka
# Komenda rysowania pierwszej serii danych z pliku out.dat:
plot "out1.dat" u 1:2 w lp ls 1 t "x(t);  = 0, F_0 = 0, W = 0.8"
#{/Symbol b}
set output "x2.png"
...
plot "out2.dat" u 1:2 w lp ls 1 t "x(t); B = 0.4, F_0 = 0, W = 0.8"

set output "x3.png"
# Komenda rysowania trzeciej serii danych z pliku out.dat:
plot "out3.dat" u 1:2 w lp ls 1 t "x(t); B = 0.4, F_0 = 0.1, W = 0.8"
